...
| Rodion / Hong Lu / Ryoshu / Sinclair core passives | `PARTIAL` | Rodion's Blessing / Despair state (and the statuses' own upkeep), Ryoshu's Petals from Sinking damage and Tremor Bursts, Gregor's Speed-free redirect and Outis' Sheut Fracture rider are live.  Open: the Plus/Minus Coin Skill replacement itself (the alternates are not in the identity data), the Hanafuda next-turn conversion, Ryoshu's "Bang. Bang." / "Stories that Never Cease" follow-up attacks and "Petals equal to the Faint Aroma inflicted", Sinclair's Evade-driven Stagger-threshold reduction. |
